...
C["position"] = {
	...
	["extra_button"] = {"TOPRIGHT", ActionButton1, "TOPLEFT", -3, 0},			-- Extra action button
	...
	unitframes = {
		...
		["player_portrait"] = {"TOPRIGHT", "oUF_Player", "TOPLEFT", -12, 26},		-- Player Portrait
		["target_portrait"] = {"TOPLEFT", "oUF_Target", "TOPRIGHT", 10, 26},		-- Target Portrait
